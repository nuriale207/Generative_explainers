...
class DoXEstimator:
	...
	def get_explanatory_illocution_from_archetype_fitness(fitness_dict):
		...
		# Modified by Nuria
		return fitness_dict["mean_relevance"]["mean"] if isinstance(fitness_dict["mean_relevance"],dict) else fitness_dict["mean_relevance"]
	...
	def get_fitness_from_answer_list(answer_list=None):
		...
		# print("answers_relevance")
		# print(answers_relevance)
		# ADDED BY NURIA TO NORMALIZE THE RELEVANCE SCORES
		# max_relevance = max(answers_relevance)
		# if max_relevance > 1:
		# 	answers_relevance = [x / max_relevance for x in answers_relevance]
		#
		# print("answers_relevance")
		# print(answers_relevance)
	...
	def estimate(self, aspect_uri_iter=None, query_template_list=None, question_generator=None, archetypal_qa_options=None, **archetype_fitness_options):
		#Se extrae el diccionario con las respuestas arquetípicas posibles por aspecto
		aspect_archetype_answers_dict = self.extract_archetypal_answers_per_aspect(
		...
		#Se extrae el diccionario con las respuestas arquetípicas posibles por aspecto filtradas en base a duplication threshold (answer_to_answer_max_similarity_threshold)
		aspect_archetype_answers_dict = self.get_filtered_aspect_archetype_answers_dict(aspect_archetype_answers_dict, **archetype_fitness_options)
